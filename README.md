...
Mobile: This app is designed specifically for mobile users who need quick access to flight predictions on the go. It leverages mobile usability for fast input and real-time interaction.

Story: Travelers often don’t know whether their flight will be delayed until the last minute. AeroPredict helps users plan better by predicting delays ahead of time.

Market: The app targets travelers, students, and frequent flyers. It has a large potential user base, especially among people who travel frequently.

Habit: Users will open the app when planning trips or checking flight updates. It can be used multiple times during a trip.

Scope: The MVP includes flight search, prediction results, saved flights, and dashboard analytics. Additional features can be added later.
...
Home Prediction Saved Flights Dashboard Profile
